...
@set QMAKE_TOOLSET_PATHSEP_PLATFORM="TOOLSET_PLATFORM=%TOOLSET%/%PLATFORM%"
...
@rem 
%QMAKE% -nocache %QMAKE_INSTALL_ROOT% %QMAKE_TOOLSET_PATHSEP_PLATFORM% %QMAKE_DIRS% %QMAKE_CXX_WARNS% %QMAKE_MISC% ..\..\..\%2
@rem -o %1
@rem 
@rem #DESTDIR=
